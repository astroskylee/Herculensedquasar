...
GIBBS_TAG = 'gibbs_source_mass'
STEP3_SUFFIX = f"{suffix}_step6_{STEP3_COSMO_TAG}_{GIBBS_TAG}"
...
SOURCE_LIGHT_SITES = vars_pixel + vars_power
LENS_MASS_SITES = vars_mass + vars_cosmo + vars_point_source

source_light_kernel = NUTS(
    model_step6,
    init_strategy=init_fun_hmc,
    target_accept_prob=0.90,
    max_tree_depth=10,
    dense_mass=[STAGE3_POWER_BLOCK],
    adapt_mass_matrix=True,
)

lens_mass_kernel = NUTS(
    model_step6,
    init_strategy=init_fun_hmc,
...
stage3_kernel = MultiHMCGibbs(
    [source_light_kernel, lens_mass_kernel],
    gibbs_sites_list=[
        SOURCE_LIGHT_SITES,
        LENS_MASS_SITES,
    ],
...
print('Using MultiHMCGibbs with source-light and lens-mass blocks:')
print('  source-light sites:', SOURCE_LIGHT_SITES)
print('  lens-mass sites:', LENS_MASS_SITES)
