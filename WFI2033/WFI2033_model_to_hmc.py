...
`WFI2033_pixel_correction_uncorrelated50.ipynb`:

1) Parametric SVI
2) Pixel stage1 SVI (no PSF correction)
3) Pixel stage2 SVI (with PSF correction)
4) Build updated RMS map using stage2-best AGN + alpha map
5) Pixel stage3 SVI (refinement under updated RMS)
6) HMC/GIBBS run (configured like notebook; initialized from stage2 median)
...
final_hmc_path = "/mnt/lustre/tianli/quasar_hmc/WFI2033_psfcorrection_all.nc"
