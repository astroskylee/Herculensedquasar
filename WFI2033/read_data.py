...
batch_list = []
for i in range(1):
    # current_batch = az.from_netcdf("/mnt/lustre/tianli/quasar_hmc/WFI2033_"+str(i)+".nc")
    current_batch = az.from_netcdf("/mnt/lustre/tianli/quasar_hmc/WFI2033_all.nc")
...
plt.tight_layout()
plt.savefig('./result/lens_model_trace.pdf')
